...
-- @Fecha:  04/10/2023
-- @Descripcion: Cambio de administración manual->auto

Prompt Conectando como sys
connect sys/system2 as sysdba

Prompt modificando a admininstración manual
...
Prompt mostrando datos finales de t02_memory_param_values
set linesize window
select * from ariadna05op.t02_memory_param_values order by sample_date;
